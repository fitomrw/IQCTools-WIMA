        ...
        <thead>
            <tr rowspan="3">
                <div class="row align-items-start">
                    <div class="col sm">
                        <img src="/img/wima_logo.png" alt="Wima Logo">
                    </div>
                    <div class="col lg-4">
                        <h3 class="text-center">QUALITY CONTROL DEPARTEMENT</h3>
                    </div>
                </div>
            </tr>
            <tr></tr>
    ...
    <div class="container-fluid">
            <table class="table table-bordered" style="border: 4px">
                <tr>
                    <td rowspan="2" style="width: 20%;">
                        <img src="/img/wima_logo.png" alt="Wima Logo" width="200" height="50"></td>
                        <td class="fw-bold text-center">QUALITY CONTROL DEPARTEMEN</td>
                </tr>
                <tr> 
                ...
                {{-- <div class="col-6"> --}}
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td> <img src="/img/img_lpp/{{ $printingLPP->gambar_lpp }}" alt="" srcset="" width="180px"></td>
                        </tr>
                        <tr>
            ...
            <div class="col-6">
                <div class="card">
                    ...
                    <div class="ms-2" style="15px">Verification Problem Status: </div>
